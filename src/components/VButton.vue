...
function btnStyle() {
  ...
  if (props.variant === 'ghost') {
    ...
    if (props.size === 'sm') {
      btnVariant = 'gap-1 text-sm before:-bottom-1 before:-left-2 before:-right-2 before:-top-1'
    } else if (props.size === 'base') {
      btnVariant = 'gap-2 text-base before:-bottom-2 before:-left-4 before:-right-4 before:-top-2'
    } else if (props.size === 'lg') {
      btnVariant = 'gap-3 text-xl before:-bottom-3 before:-left-6 before:-right-6 before:-top-3'
    }
  } else {
