...
<template>
  ...
  >
    ...
    <div
      class="mr-2 flex h-10 w-10 items-center justify-center rounded-full bg-blue-500/20 group-hover:enabled:bg-blue-500/50 group-active:enabled:bg-blue-600/20"
    >
